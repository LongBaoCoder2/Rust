...
impl QueensBoard {
    ...
    pub fn is_safe(&self, col: usize, row: usize) -> bool {
        ...
        !self.columns[col] && !self.main_diag[col - row + size - 1] && !self.sub_diag[col + row]
    }
    ...
    pub fn update(&mut self, col: usize, row: usize, value: bool) {
        ...
        self.main_diag[col - row + size - 1] = value;
    ...
    pub fn convert_to_string_result(&self) -> Vec<Vec<String>> 
    {
        ...
        for board in &self.result {
            ...
            for col in board {
                ...
                base_res.push(base_string);
            }
            str_result.push(base_res);
        }
